  ...
  return (
    <ContainerDefault>
      <TabsWrapper>
        ...
        {taskFiles &&
          taskFiles?.filter(
            (obj: FilesMap) => obj.products_delivery_id === productInfos.products_delivery_id
          ).length > 0 && (
            <TaskTab
              onClick={(e: any) => {
                setSelectedTab(e.target.innerText);
        ...
        {uploadEnabled && !finalCard && !uploadClient && (
          <ButtonsWrapper>
            {/* {sendToApprove && (
